...
export class PoolApp {
    ...
    this._live = {
      ...
      dirty: new Set(),
      // true whenever a real rebuild still needs to be committed on release
      commitNeeded: false,
...
setupPoolEditor() {
  ...
  async _flushRebuildNow() {
    ...
    // If nothing changed and there is no pending commit, skip
    ...
    // Rebuild committed; reset preview bookkeeping against the new geometry baseline.
