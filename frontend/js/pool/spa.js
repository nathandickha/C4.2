...
const SPA_SEAT_THICKNESS = 1.98; // raised bench/seat bottom by 200mm while keeping seat top level
...
function updateSpaWalls(spa) {
  ...
  const bottomZ=getDeepFloorZ(poolParams), topZ=getEffectiveSpaTopOffset(), h=topZ-bottomZ; spa.userData.height=h; spa.position.z=bottomZ+h/2;
