    ...
    const addSpaSectionCaps = () => {
      ...
      spa.traverse((obj) => {
        ...
        if (obj.userData?.isSpaSeat) {
          // Bring back the seat cap, but trim it so it only runs down to the
          // spa floor top instead of spanning the full seat bounds. This keeps
          // the seat cut face without recreating the large centre cap bar.
