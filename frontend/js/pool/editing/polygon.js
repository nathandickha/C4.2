...
export class EditablePolygon {
  ...
  rescaleTo(targetLength, targetWidth) {
    ...
    // --- Custom/curved mode: resize by pushing the outside sides in/out
    // instead of globally scaling the whole polygon. This preserves curved
    // wall radii and avoids stretching the entire customised outline when
    // only pool length/width should change.
