    ...
    const addSpaSectionCaps = () => {
      ...
      spa.traverse((obj) => {
        ...
        if (obj.userData?.isSpaFloor) {
          // Keep bounds only; do not project a separate floor cap. With the
          // full-footprint support below, a floor overlay reads as a false
          // centre cap through the section.
