...
setupPoolEditor() {
  ...
  _applyLivePreviewFromDirty() {
    ...
    // Hybrid live preview:
    // - footprint changes now use throttled accurate rebuilds so coping widths,
    //   wall thicknesses, and custom curved-wall radii are not distorted by
    //   temporary group scaling.
    // - shallow/deep/shallowFlat/deepFlat still use lightweight depth preview.
    ...
    // Never preview footprint changes via poolGroup scaling. That visually stretches
    // coping and custom curves during slider drags.
