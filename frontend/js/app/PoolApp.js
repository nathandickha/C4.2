  ...
  _setSectionOverlay(bounds, enabled, cutY = null, wallThickness = 0.2) {
    ...
    const addSectionBand = (x0, x3, includeWaterTint = true) => {
      ...
      const leftWallShape = new THREE.Shape([
        ...
        new THREE.Vector2(x0, leftDepth - safeWallThickness),
        new THREE.Vector2(x0 - safeWallThickness, leftDepth - safeWallThickness)
      ]);
      ...
      const rightWallShape = new THREE.Shape([
        ...
        new THREE.Vector2(x3 + safeWallThickness, rightDepth - safeWallThickness),
        new THREE.Vector2(x3, rightDepth - safeWallThickness)
      ]);
